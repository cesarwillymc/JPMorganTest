 ...
 * No mapper needed
 */
abstract class SuspendNoParamsUseCase<out Results>(
    ...
    protected abstract suspend fun execute(): Result<Results>
}

suspend operator fun <Results> SuspendNoParamsUseCase<Results>.invoke(): Result<Results> = this()
